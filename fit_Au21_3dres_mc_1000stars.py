...
DATAFILE_MC = 'data_Au21_mc_nstars_1000_nmc_1000.pkl'
...
RESTART     = False
BACKEND     = True
BACKENDFILE = "Backend_Au21_3d_MC_nstars_"+str(NSTARS)+".h5"
...
initial_guess = np.array([2.5,5.3,7000., 0.8,1.,0.9,0.9,-0.3,1.4*(10**7.),17.,0.8])
...
# for i in range(n):
#     start1 = time.time()
#     par_ = np.array([2.5,5.5,8000.,0.75,1.7,0.88,1.1,0.5,rho0_[i],17.,0.9])

...
DATAFILE_MC = "data_mc_nstars_100_nmc_10000.pkl"
#DATAFILE_MC = "data_mc_nstars_100_nmc_2000.pkl"
with open(DATAFILE_MC, 'rb') as f:
    data_mc = pickle.load(f)


NSTARS = 100
NMC = 10000  # number of mc samples for marginalisation calculation
VERBOSE = True
...
# =============================================================================
    ...
    prob_mc_flatten = df(acts_mc_flatten)/norm
...
# =============================================================================
    ...
    logL = np.sum(np.log(prob))  # assuming all particles have equal mass
    #print('logL: '+str(logL))
...
initial_guess = np.array(
    [2.2, 5.3, 7000., 0.8, 1., 0.9, 0.9, -0.3, 1.2*(10**7.), 16., 0.7])
...
# for i in range(n):
#     start1 = time.time()
#     par_ = np.array([slopein_[i], 5.5, 8000., 0.75, 1.7, 0.88,
...
#                       3.14070861*(10**(-3)), 1.65596997, 7.48602423 *
#                       0.1, -9.56014909*(10**(-3)),
